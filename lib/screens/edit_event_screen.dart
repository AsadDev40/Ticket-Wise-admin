...
import 'package:ticket_wise_admin/widgets/time_picker.dart';
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if (eventdateController.text.isEmpty) {
                        EasyLoading.dismiss();
                        Utils.showToast("Please enter an event date.");
                        return;
                      }
                      ...
                      if (cityProvider.selectedValue == null) {
                        EasyLoading.dismiss();
                      ...
                      // Dismiss loading and navigate to the events screen
                      EasyLoading.dismiss();
